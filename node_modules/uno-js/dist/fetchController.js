...
var defaultHeadersResolver = function (url, accessToken) {
...
function getResponse(url, accessToken, requestMethod, requestBody, headersResolver) {
    if (requestMethod === void 0) { requestMethod = "GET" /* Get */; }
    var request = getRequest(url, accessToken, requestMethod, requestBody, headersResolver !== null && headersResolver !== void 0 ? headersResolver : defaultHeadersResolver);
    return fetch(request);
}
exports.getResponse = getResponse;
function requestController(options, url, accessToken, requestMethod, requestBody) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getResponse(url, accessToken, requestMethod, requestBody, options.headersResolver)];
                case 1:
                    response = _a.sent();
...
function createFetchController(options) {
    ...
    return function (url, accessToken, requestMethod, requestBody) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/, requestController(options, url, accessToken, requestMethod, requestBody)];
    }); }); };
}
